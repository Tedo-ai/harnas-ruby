...
a specification for LLM agent harnesses. Passes 54/54 conformance fixtures
against the spec; live providers Anthropic + OpenAI + Gemini + Ollama; 674 RSpec
...
```sh
bundle install
bundle exec rspec               # 674 examples
bundle exec rubocop             # clean
bundle exec bin/conformance.rb  # 54/54 fixtures
