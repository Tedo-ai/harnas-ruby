...
a specification for LLM agent harnesses. Passes 46/46 conformance fixtures
against the spec; live providers Anthropic + OpenAI + Gemini + Ollama; 658 RSpec
...
```sh
bundle install
bundle exec rspec               # 658 examples
bundle exec rubocop             # clean
bundle exec bin/conformance.rb  # 46/46 fixtures
