...
a specification for LLM agent harnesses. Passes 79/79 conformance fixtures
against the spec; live providers Anthropic + OpenAI + Gemini + Ollama; 735 RSpec
...
```sh
bundle install
bundle exec rspec               # 735 examples
bundle exec rubocop             # clean
bundle exec bin/conformance.rb  # 79/79 fixtures
